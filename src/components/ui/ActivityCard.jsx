  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 flex overflow-hidden w-full hover:shadow-md transition-shadow">
      ...
      <div className="relative w-[400px] flex-shrink-0">
        <img
          src="https://images.unsplash.com/photo-1502680390468-be998c86bcaa?w=400&h=300&fit=crop&auto=format"
          alt="Bali Surf Lesson"
        ...
        <span className="absolute bottom-2 left-2 bg-white/95 text-gray-800 text-[12px] font-bold px-2.5 py-1 rounded-lg shadow-sm">
          🏄 Surfing
        </span>
      </div>
      ...
      <div className="flex-1 px-5 py-4 flex flex-col gap-1">
        <h2 className="text-[17px] font-extrabold text-gray-900 leading-snug">
          Bali Surf Lesson — 2 Hours with Pro Instructor
        </h2>
        ...
        <div className="flex items-center gap-1.5 text-gray-500 text-[13px] mt-1 flex-wrap">
          <span>Kuta Beach, Bali, Indonesia</span>
          <a
            href="#"
        ...
        <p className="text-[13.5px] font-bold text-gray-900">Beginner-friendly group lesson</p>
        <p className="text-[12.5px] text-gray-500">
          Board, wetsuit, and refreshments included
        </p>
        ...
        <p className="text-green-600 text-[12.5px]">
          Instant confirmation — book now, pay on arrival.
        </p>

        <div className="flex gap-2 flex-wrap mt-2">
          {["Small group", "Equipment included", "Hotel pickup"].map((tag) => (
            <span
              key={tag}
      ...
      <div className="flex flex-col justify-between items-end px-5 py-4 min-w-[180px] border-l border-gray-100">
        <div className="flex items-center gap-2">
          <div className="text-right">
            ...
            <p className="text-[12px] text-gray-500">892 reviews</p>
          </div>
        ...
        <div className="text-right">
          ...
          <p className="text-[12px] text-gray-500">All fees included</p>
